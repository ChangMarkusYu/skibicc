...
//! Given a UTF-8 string `s`, converts its first character from UTF-8 encoding
//! to unicode code point and stores the result in `out`. Returns `s` after
//! skipping the converted character. Note that UTF-8 is a variable length
